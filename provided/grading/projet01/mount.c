...
int mountv6(const char *filename, struct unix_filesystem *u)
{
    ...
    // correcteur : [FOPEN_INVALID_MODE] 'rd' n'est pas un mode valide (cf man 3 fopen), vous devriez utiliser 'r' ici
    ...
    // correcteur : pourquoi vous compliquer autant la vie ? il suffirait de faire le sector_read directement dans u->s plutôt que dans 'superblock'
